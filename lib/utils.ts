...
export const USDC_CONTRACT = '17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1'
...
export const BITTE_CHAT_API_URL = 'https://ai-runtime-446257178793.europe-west1.run.app/chat'
...
export function logTradingAgentData({
  ...
  const { totalUsd, tradingValue, usdcValue, pnlPercent, currentPositions, positionsWithPnl } =
    context
