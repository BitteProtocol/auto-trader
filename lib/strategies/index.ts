...
export const DEFAULT_STRATEGY: StrategyConfig = {
  ...
  step1Rules: "Risk targets: SELL at +2% profit OR -1.5% loss. Close losing positions faster than winners (cut losses, let profits run). Don't close positions with raw balance below 1000.",
